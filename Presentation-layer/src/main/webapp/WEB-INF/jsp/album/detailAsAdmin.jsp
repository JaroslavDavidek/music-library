<%-- 
    ...
    Created on : 13.12.2015, 14:28:37
    Author     : Peter Franek
--%>
...
<own:masterpage>
    <jsp:attribute name="body">
        ...
        <form:form method="POST" modelAttribute="albumDetail" acceptCharset=""
                   action="${pageContext.request.contextPath}/album/detailAsAdmin/${id}">
