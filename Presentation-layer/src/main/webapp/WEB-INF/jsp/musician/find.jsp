...
<jsp:attribute name="body">
    ...
    <form:form method="POST" modelAttribute="searchDTO" acceptCharset="" 
        ...
        <div class="col-md-12 form-group ${title_error?'has-error':''}">
            <form:label path="sortAscending" cssClass="col-sm-2 text-right control-label">Use ascending order</form:label>
            <div class="col-sm-1">
                <form:checkbox path="sortAscending" cssClass="col-sm-1 form-control"/>
            </div>
            <button class="btn btn-primary " type="submit">Find</button>
        </div>
    </form:form>
